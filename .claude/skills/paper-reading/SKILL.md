---
name: paper-reading
description: Download and analyze academic papers (mainly arXiv) using Moonshot AI (Kimi) — generates notes, summaries, code scaffolds, glossaries, and reading guides. Use when the user wants to fetch, read, summarize, deeply analyze, or implement a research paper given an arXiv ID/URL or a local PDF.
license: MIT
---
